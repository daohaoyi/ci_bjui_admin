...
<html>
	<head>
		...
		<script src="<?=base_url().'js/sha256.js';?>"></script>
		<link href="<?=base_url().'BJUI/themes/css/bootstrap.min.css';?>" rel="stylesheet">
		<style type="text/css">
		* {font-family: "Verdana", "Tahoma", "Lucida Grande", "Microsoft YaHei", "Hiragino Sans GB", sans-serif;}
		body {
		    background: url(<?=base_url().'public/images/loginbg_01.jpg';?>) no-repeat center center fixed;
		...
		function choose_bg() {
			...
			$('body').css('background-image', 'url(<?=base_url().'public/images/loginbg_0'?>'+ bg +'.jpg)');
		}
		</script>
	</head>
	<body>
		...
		<div class="main_box">
			...
			<div class="login_box">
		        ...
		        <div class="login_form">
		    		<?=form_open('login/do_login', array('id' => 'login_form')); ?>
		    			<div class="form-group">
		    				<label for="j_username" class="t">用户名：</label> <input id="j_username" value="<?= set_value('username'); ?>" name="username" type="text" class="form-control x319 in" autocomplete="off">
		    			</div>
		    			<div class="form-group">
		    				<label for="j_password" class="t">密　码：</label> <input id="j_password" value="<?= set_value('passwordhash'); ?>" name="passwordhash" type="password" class="form-control x319 in">
		    			</div>
		    			<div class="form-group">
		    				<label for="j_captcha" class="t">验证码：</label> <input id="j_captcha" name="j_captcha" type="text" class="form-control x164 in" value="">
		    				<img id="captcha_img" alt="点击更换" title="点击更换" src="<?=site_url('Login/change_code');?>" class="m" onclick='document.getElementById("captcha_img").src = "<?=site_url("Login/change_code/time/");?>"+Math.random();'>
		    			</div>
		    			<!-- 
		    			<div class="form-group">
                        	<label for="j_etkey" class="t">ETKEY：</label> <input id="j_etkey" name="j_etkey" type="text" class="form-control x164">
	                    	<div style="color:red;width:200px;float:right;margin-right:20px;margin-top:3px;">
	                            TODO error_message 
	                       	</div >
                    	</div>
                    	 -->
		    			<div class="form-group">
		    				...
		    				<div style="color:red;width:200px;float:right;margin-right:40px;margin-top:-2px;">
	                            <?=validation_errors(); ?>  
	                       	</div >
		    			</div>
