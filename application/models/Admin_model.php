...
class Admin_model extends MY_Model{
	 ...
	 * @return Array 一维数组
	 */
	public function get_one($where = array(), $fields = array('id','name','roleid','usertype','state'), $orderby = 'id desc', $groupby = array())
	{
	 ...
	 * @return Array 二维数组
	 */
	public function get_list($where = array(), $fields = array('id','name','roleid','usertype','state'), $limit = array(0,20), $orderby = 'id desc', $groupby = array())
	{
		$this->db_connect($this->db_group_name, 0);
		$this->table_name = $this->table;
		$this->fields = $fields;
