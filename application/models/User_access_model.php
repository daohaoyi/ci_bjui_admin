...
class User_access_model extends MY_Model{
	 ...
	 * @return Array 一维数组
	 */
	public function get_one($where = array(), $orderby = 'user_id desc', $groupby = array())
	{
	 ...
	 * @return string
	 */
	public function get_one_key_map($key_name=NULL, $where = array(), $orderby = 'user_id desc', $groupby = array())
	{
		$this->db_connect($this->db_group_name, 0);
		$this->table_name = $this->table;
	 ...
	 * @return Array 二维数组
	 */
	public function get_list($where = array(), $limit = array(0,20), $orderby = 'user_id desc', $groupby = array())
	{
		$this->db_connect($this->db_group_name, 0);
		$this->table_name = $this->table;
	 ...
	 * @return Array 二维数组
	 */
	public function get_list_map($key_name=NULL, $where = array(), $limit = array(0,20), $orderby = 'user_id desc', $groupby = array())
	{
		$this->db_connect($this->db_group_name, 0);
		$this->table_name = $this->table;
	 ...
	 * @return Array 一维数组
	 */
	public function get_list_key_map($key_name=NULL, $where = array(), $limit = array(0,20), $orderby = 'user_id desc', $groupby = array())
	{
		$this->db_connect($this->db_group_name, 0);
		$this->table_name = $this->table;
	 ...
	 * @param string $sql 查询语句，如SELECT * FROM some_table WHERE user_id = ? AND status = ? AND author = ?
